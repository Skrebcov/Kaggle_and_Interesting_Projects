...
| :- | :------- | :------- | :--------- | :-------- |
| 1 | [Векторный поиск подходящих чанков](https://github.com/Skrebcov/wb_vector_search) | Разработал систему интеллектуального поиска релевантных фрагментов информации, используя гибридный подход с BERT и TF-IDF. Реализовал принцип Парето (80/20) для оптимизации обработки вопросов. | FastAPI, BERT, TF-IDF, векторные представления, косинусное сходство | Точный подбор релевантных чанков для топ-1/3/5 запросов |
